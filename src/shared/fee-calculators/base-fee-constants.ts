...
export const FEE_CALCULATION_CONSTANTS = {
  ...
  // Additional constants for fee calculation
  BYTES_PER_USD_CENT: 0.0001,              // Base rate per byte
  SIGNATURE_FEE_PER_BYTE: 0.001,           // Fee per signature byte
} as const;

/**
 * Get fee calculation constants for external use
 */
export function getFeeConstants(): typeof FEE_CALCULATION_CONSTANTS {
 ...
 */
export function updateFeeConstants(newConstants: Partial<typeof FEE_CALCULATION_CONSTANTS>): void {
